...
## Exclusive-drop to arcade-flow validation

Desktop and mobile full-page checks confirm that the Jersh In Case artist credit now has an explicit label plus high-contrast artist and feature lines. The graffiti “EXCLUSIVE DROP → PLAY THE ARCADE” stamp and side/bottom direction arrows remain within the release-to-arcade transition and frame the Selector Showdown cabinet without covering interactive controls. The mobile layout retains the artist-credit hierarchy and constrains the arrows to the arcade flow area.
