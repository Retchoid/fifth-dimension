...
const requirements: Array<[string, string, string]> = [
  ...
  ["rear-view runner sprite", game, "selector-dj-rear-runner-transparent_35d3ab26"],
  ...
  ["clear-lane urban stage art", gameVisualStyles, "selectah-level-one-urban-stage-reference_43ddc07a.webp"],
  ["game Level 2 background visual grammar", gameVisualStyles, ".level-two-booth"],
  ["dedicated Level 2 crowd-pressure stage art", gameVisualStyles, "5d-selector-level-two-detailed-stage_89e2157b.webp"],
  ...
  ["detailed illustrated splash scene layer", detailedArcadeSceneStyles, "selectah-splash-art-direction_4d1c250f.webp"],
  ["detailed game-over rave background", detailedArcadeSceneStyles, "5d-selector-rave-stage_e4fdff4b.webp"],
  ["approved deck and mixer reward art", detailedArcadeSceneStyles, "selectah-mixer-urban_aa64e423.webp"],
  ...
  ["smaller shared falling record", game, "record: { width: 5, height: 5, visualSize: 14, visualScale: 1.9"],
  ...
  ["shared collision resolver", game, "const resolvedItem = resolveWorldCollision(playerWorldRef.current, movedItem);"],
  ...
  ["phone crowd warning", game, "crowdHazardVariantRef.current = \"phone\";"],
  ...
  ["fair named-hazard exposure schedule", game, "const scheduledNamedHazard = scheduledNamedHazardExposure(activeFallingLevel, namedHazardSpawnCountRef.current);"],
  ...
  ["in-world reward layer", game, "in-world-reward${rewardToRender.kind"],
  ["first-bonus clean-run rule", game, "const firstBonusEligible = bonusEligibleRef.current;"],
