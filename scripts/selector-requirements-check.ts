...
const requirements: Array<[string, string, string]> = [
  ...
  ["non-blocking reward dispatcher", game, "announceInWorldReward(rewardCopy[sequence].label, rewardCopy[sequence].quip);"],
  ["in-world reward layer", game, "className=\"in-world-reward\""],
