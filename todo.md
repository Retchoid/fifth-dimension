...
- [ ] Perform read-only image load runtime diagnostic on selectah-dubplate-5d-production-v2.png
...
- [ ] Decode and inspect pixel raster bounds of selectah-dubplate-5d-production-v2.png
